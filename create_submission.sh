...
| grep -Ev  '^from gravitas|^from networkx|^*self\.plot_*|root_dir|import scipy.stats as ss' > /home/ruhkopf/PycharmProjects/Meta_challenge/submission/submission_docs/agent.py
